...
if not tostring(group) then print('Hata grubu adı bir dize olmalıdır! (' .. tostring(group) .. ')') return end
...
if not tostring(user) then print('Hata SteamID bir dizge olmalı! (' .. tostring(user) .. ')') return end
